        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="about-img">
                        <img src="img/ramen2.jpeg" alt="" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
                    <div class="about-text">
                        <h2>Ramen<br>Recipe</h2>
                        <p>
                        <?php
// Fungsi untuk mencetak resep ramen
function cetakResepRamen()
{
    $bahan = [
        "200 gram mie ramen",
        "500 ml kaldu ayam",
        ...
        "Secukupnya biji wijen panggang"
    ];

    $langkah = [
        "Rebus mie ramen sesuai petunjuk kemasan. Tiriskan dan sisihkan.",
        "Panaskan sedikit minyak sayur dalam wajan. Tumis bawang putih dan jahe hingga harum.",
        "Tambahkan kaldu ayam, kecap asin, kecap manis, minyak wijen, garam, dan merica bubuk. Aduk rata dan masak hingga mendidih.",
        "Tambahkan mie ramen ke dalam kaldu dan masak hingga matang.",
        "Angkat mie ramen ke dalam mangkuk saji. Tambahkan irisan daun bawang dan biji wijen panggang di atasnya.",
...
// Memanggil fungsi untuk mencetak resep ramen
cetakResepRamen();
?>
