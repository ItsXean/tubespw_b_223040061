        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="about-img">
                        <img src="img/katsu2.png" alt="" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
                    <div class="about-text">
                        <h2>Chicken Katsu<br>Recipe</h2>
                        <p>
                        <?php
// Fungsi untuk mencetak resep Chicken Katsu
function cetakResepChickenKatsu()
{
    $bahan = [
        ...
        "Panko (roti tawar Jepang) secukupnya",
    ...
    $langkah = [
        "Iris dada ayam fillet menjadi beberapa bagian. Lumuri dengan garam dan lada hitam.",
        "Gulingkan dada ayam dalam tepung terigu, lalu celupkan ke dalam telur kocok, dan terakhir gulingkan dalam panko hingga rata. Ulangi langkah ini untuk semua potongan ayam.",
        "Panaskan minyak dalam wajan. Goreng potongan ayam hingga matang dan berwarna keemasan. Tiriskan di atas kertas minyak.",
        "Untuk membuat saus, campurkan semua bahan saus dalam wajan kecil. Panaskan sambil terus diaduk hingga mendidih dan mengental.",
        "Potong-potong chicken katsu dan sajikan dengan saus di atasnya."
    ];
...
// Memanggil fungsi untuk mencetak resep Chicken Katsu
cetakResepChickenKatsu();
?>
