        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="about-img">
                        <img src="img/sushi2.jpeg" alt="" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
                    <div class="about-text">
                        <h2>Sushi<br>Recipe</h2>
                        <p>
                        <?php
// Fungsi untuk mencetak resep sushi
function cetakResepSushi()
{
    $bahan = [
        "500 gram nasi sushi",
        "300 gram ikan segar (misalnya salmon, tuna), iris tipis",
    ...
    $langkah = [
        "Siapkan selembar nori di atas rolling mat (makisu).",
        "Ambil secukupnya nasi sushi, ratakan di atas nori dengan ketebalan sesuai selera.",
        "Tambahkan irisan ikan, mentimun, dan alpukat di tengah nasi.",
        "Gulung nori menggunakan rolling mat dengan rapi dan kuatkan tekanan agar sushi tidak mudah lepas.",
        "Potong sushi roll menjadi beberapa bagian dengan pisau yang tajam.",
        "Ulangi proses untuk sisa bahan.",
        "Sajikan sushi dengan kecap asin, wasabi, dan jahe."
    ];
...
// Memanggil fungsi untuk mencetak resep sushi
cetakResepSushi();
?>
