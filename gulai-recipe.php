        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="about-img">
                        <img src="img/gulai2.png" alt="" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
                    <div class="about-text">
                        <h2>Gulai Nangka<br>Recipe</h2>
                        <p>
                        <?php
                          // Fungsi untuk mencetak resep gulai nangka
                          function cetakResepGulaiNangka()
                          {
                              $bahan = [
                              ...
                              $langkah = [
                                  "Pertama, panaskan minyak dalam wajan besar. Tumis bumbu halus, daun jeruk, serai, lengkuas, dan daun salam hingga harum dan matang.",
                                  "Masukkan potongan nangka muda, aduk rata dan masak hingga nangka sedikit layu.",
                                  ...
                                  "Kecilkan api dan masak gulai nangka dengan api kecil hingga nangka empuk dan bumbu meresap. Ini memakan waktu sekitar 1-2 jam. Aduk sesekali untuk menghindari adanya lapisan santan yang pecah.",
                                  "Tambahkan garam secukupnya dan aduk rata.",
                                  "Angkat gulai nangka dari api dan biarkan dingin sebentar sebelum disajikan."
                              ];
                          ...
                          // Memanggil fungsi untuk mencetak resep gulai nangka
                          cetakResepGulaiNangka();
                        ?>                          
